...
export function getDebugElement( fixture: ComponentFixture<any>, componentHtml: string, name: string | null= null ): DebugElement {
...
export function getDebugLegend( de: DebugElement ): string | null {
  const _de = de.query( By.css( 'legend' ) );
  return _de ? _de.nativeElement.textContent : null;
}

export function getDebugInlineError( de: DebugElement ): string | null {
  const _de = de.query( By.css(  'common-error-container' ) );
  return _de ? _de.nativeElement.textContent : null;
}

export function getDebugLabel( de: DebugElement, name: string ): string | null {
  const _de = de.query( By.css( 'label[for="' + name + '"]' ) );
  return _de ? _de.nativeElement.textContent : null;
}

export function setInput( de: DebugElement, value: any, labelName: string | null = null ) {
...
// Value of the option
export function setSelect( de: DebugElement, value: any, labelName: string | null = null ) {
