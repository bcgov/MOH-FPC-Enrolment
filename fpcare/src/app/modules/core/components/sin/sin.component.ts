...
export class SinComponent extends Masking implements OnInit, OnChanges, OnDestroy {
  ...
  public uniqueSinErrMsg = 'Social Insurance Number (SIN) was already used for another family member.';

  public uniqueSins = true;
